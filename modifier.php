...
<section>
        <form action='' method="post" class='mainform' enctype="multipart/form-data">
            ...
            <input id="Area" name="Area" type="number" value="<?=$response['superficie']?>">
            ...
            <?php 
                if($response['type_annonce'] == 'Location'){
                    $typeLocation = 'checked';
                    $typevente = '';
                }if($response['type_annonce'] == 'vente'){
                    $typeLocation = '';
                    $typevente = 'checked';
                }
                ?>
            ...
            <div class="type">
                <h6>Location</h6>
                <input id="location" name="type" type="radio" value="Location" <?=$typeLocation?>>
                <h6>Vente</h6>
                <input id="vente" name="type" type="radio" value="vente" <?=$typevente?>>
            </div>
